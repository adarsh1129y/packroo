    ...
    if (getSuggestionsBtn) {
        getSuggestionsBtn.addEventListener('click', () => {
            ...
            setTimeout(() => {
                ...
                const suggestions = [
                    { title: 'Cloudy Mountain Escape', desc: 'Enjoy misty mornings and breathtaking views in Munnar.' },
                ...
                suggestions.forEach(s => {
                    ...
                    card.innerHTML = `<div class='suggestion-title'>${s.title}</div><div class='suggestion-desc'>${s.desc}</div>`;
